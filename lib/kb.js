  ...
  this.Kb = (function() {
    class Kb {
      ...
      constructor(cfg) {
        ...
        //---------------------------------------------------------------------------------------------------------
        this._detect_latch_events = this._detect_latch_events.bind(this);
        //---------------------------------------------------------------------------------------------------------
...
/* !!!!!!!!!!!!!!!!!!!!!! */            return null;
      ...
      _detect_latch_events(callback) {
        ...
        get_double_key = function() {
          ...
          if (!((Date.now() - ((ref = (ref1 = shreg[0]) != null ? ref1.t : void 0) != null ? ref : 0)) < this.cfg.latch.dt)) {
            return null;
          }
      ...
      _add_listener_for_behavior(behavior) {
        ...
        switch (behavior) {
          ...
          case 'down':
            ...
            break;
          case 'latch':
            this._detect_latch_events(null, (event) => {
              return this._call_handlers(behavior, event);
            });
            break;
          case 'toggle':
