(function() {
  'use strict';
  var Column, Distributor, Finder, Iframe_walker, Node_walker, Slug, Slug_walker, TU, Walker, after, defer, every, sleep;
  ...
  Iframe_walker = class Iframe_walker extends Walker {
    ...
    step() {
      ...
      local_linefinder = new this.window.µ.LINE.Finder();
